...
export const PatrimoineApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async crupdatePatrimoines(
      getPatrimoines200Response?: GetPatrimoines200Response,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetPatrimoines200Response>> {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['PatrimoineApi.crupdatePatrimoines']?.[localVarOperationServerIndex]?.url;
    ...
    async getPatrimoineByNom(
      ...
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Patrimoine>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPatrimoineByNom(nomPatrimoine, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PatrimoineApi.getPatrimoineByNom']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPatrimoines(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PatrimoineApi.getPatrimoines']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const PossessionApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async crupdatePatrimoinePossessions(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PossessionApi.crupdatePatrimoinePossessions']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async deletePatrimoinePossessionByNom(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deletePatrimoinePossessionByNom(
        nomPatrimoine,
        nomPossession,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PossessionApi.deletePatrimoinePossessionByNom']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPatrimoinePossessionByNom(
      ...
      nomPossession: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PossessionAvecType>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPatrimoinePossessionByNom(
        nomPatrimoine,
        nomPossession,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PossessionApi.getPatrimoinePossessionByNom']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPatrimoinePossessions(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPatrimoinePossessions(
        nomPatrimoine,
        page,
        pageSize,
        options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PossessionApi.getPatrimoinePossessions']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const PossessionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    getPatrimoinePossessionByNom(
      ...
      nomPossession: string,
      options?: any
    ): AxiosPromise<PossessionAvecType> {
      return localVarFp
...
export const ProjectionFutureApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getPatrimoineFluxImpossibles: async (
      ...
      const localVarPath = `/patrimoines/{nom_patrimoine}/flux-impossibles`.replace(
        `{${'nom_patrimoine'}}`,
        encodeURIComponent(String(nomPatrimoine))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      ...
      if (debut !== undefined) {
        localVarQueryParameter['debut'] =
          (debut as any) instanceof Date ? (debut as any).toISOString().substring(0, 10) : debut;
      }

      if (fin !== undefined) {
        localVarQueryParameter['fin'] =
          (fin as any) instanceof Date ? (fin as any).toISOString().substring(0, 10) : fin;
      }
...
export const ProjectionFutureApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getPatrimoineFluxImpossibles(
      ...
      fin?: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetPatrimoineFluxImpossibles200Response>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPatrimoineFluxImpossibles(
        nomPatrimoine,
        debut,
        fin,
        options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ProjectionFutureApi.getPatrimoineFluxImpossibles']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPatrimoineGraph(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ProjectionFutureApi.getPatrimoineGraph']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
